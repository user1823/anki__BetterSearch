...
class SearchBox(QDialog):
    ...
    def __init__(self, parent, searchstring, in_browser=True, relevant_line_edit=False):
        if browser_searchEdit_hint_shown(searchstring, parent):
            self.searchstring = ""
        else:
        ...
        self.relevant_line_edit = relevant_line_edit  # relevant for filtered deck dialog
        self.mw = parent.mw
    ...
    def onButton(self, arg, remove_on_cancel=True):
        ...
        button_helper(self.form.pte, self.parent, self.mw, self.col, arg, remove_on_cancel)
        self.raise_()

    def text_change_helper(self):
        text_change_helper(self.form.pte, self.parent, self.mw, self.col)
    ...
    def accept(self):
        ...
        if isMac:
            if self.in_browser:
                ...
                self.relevant_line_edit.setText(self.newsearch)
